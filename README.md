...
- **招聘信息广场（多源聚合）**：内置精选（秋招 / 多频道 / 行业 / 服务）+ 免费公开招聘 API（RemoteOK / Remotive / Arbeitnow）+ 可配置第三方渠道，统一去重入库；支持关键词 / 行业 / 职位类型 / 地点 / 学历 / 经验 / 来源 / 招聘类型多条件筛选，截止前站内提醒 🆕
- **简历跨软件取件**：支持从微信、QQ、钉钉、WPS 云文档、腾讯文档、百度网盘、超级简历、BOSS 直聘等常用软件一键取用简历（移动端唤起 App，桌面端直达网页版），并可直接选择本机文件或粘贴剪贴板 🆕
